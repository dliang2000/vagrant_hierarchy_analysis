...
xml_file = '/home/vagrant/benchmarks/plexus-utils-plexus-utils-3.3.0/plexus_utils_3.3.0_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/plexus_utils_3.3.0_missing_methods.csv', 'w', newline='') as outcsv:
