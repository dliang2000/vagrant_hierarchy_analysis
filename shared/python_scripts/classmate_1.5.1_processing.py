...
xml_file = '/home/vagrant/benchmarks/java-classmate-classmate-1.5.1/classmate_1.5.1_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/classmate_1.5.1_missing_methods.csv', 'w', newline='') as outcsv:
