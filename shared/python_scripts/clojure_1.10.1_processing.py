...
xml_file = '/home/vagrant/benchmarks/clojure-clojure-1.10.1/clojure_1.10.1_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/clojure_1.10.1_missing_methods.csv', 'w', newline='') as outcsv:
