...
xml_file = '/home/vagrant/benchmarks/quartz-quartz-2.3.1/quartz_core_2.3.1_coverage.xml '
...
with open('/home/vagrant/benchmarks/csv/quartz_core_2.3.1_missing_methods.csv', 'w', newline='') as outcsv:
