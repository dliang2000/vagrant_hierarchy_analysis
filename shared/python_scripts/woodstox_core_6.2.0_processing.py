...
xml_file = '/home/vagrant/benchmarks/woodstox-woodstox-core-6.2.0/woodstox_core_6.2.0_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/woodstox_core_6.2.0_missing_methods.csv', 'w', newline='') as outcsv:
