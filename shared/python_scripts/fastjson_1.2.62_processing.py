...
xml_file = '/home/vagrant/benchmarks/fastjson-1.2.62/fastjson_1.2.62_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/fastjson_1.2.62_missing_methods.csv', 'w', newline='') as outcsv:
