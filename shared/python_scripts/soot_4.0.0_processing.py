...
xml_file = '/home/vagrant/benchmarks/soot-4.0.0/soot_4.0.0_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/soot_4.0.0_missing_methods.csv', 'w', newline='') as outcsv:
