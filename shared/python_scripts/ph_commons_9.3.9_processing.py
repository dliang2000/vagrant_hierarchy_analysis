...
xml_file = '/home/vagrant/benchmarks/ph-commons-ph-commons-parent-pom-9.3.9/ph_commons_ph_commons_9.3.9_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/ph_commons_9.3.9_missing_methods.csv', 'w', newline='') as outcsv:
