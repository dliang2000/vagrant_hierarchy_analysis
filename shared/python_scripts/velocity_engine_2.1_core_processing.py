...
xml_file = '/home/vagrant/benchmarks/velocity-engine-2.1/velocity_engine_2.1_core_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/velocity_engine_2.1_core_missing_methods.csv', 'w', newline='') as outcsv:
