...
xml_file = '/home/vagrant/benchmarks/jgrapht-jgrapht-1.3.1/jgrapht_1.3.1_core_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/jgrapht_1.3.1_core_missing_methods.csv', 'w', newline='') as outcsv:
