...
xml_file = '/home/vagrant/benchmarks/castor-1.4.0/castor_1.4.0_schema_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/castor_1.4.0_schema_missing_methods.csv', 'w', newline='') as outcsv:
...
xml_file = '/home/vagrant/benchmarks/castor-1.4.0/castor_1.4.0_codegen_coverage.xml'
...
with open('/home/vagrant/benchmarks/csv/castor_1.4.0_codegen_missing_methods.csv', 'w', newline='') as outcsv:
    writer = csv.writer(outcsv, delimiter=',', quoting=csv.QUOTE_MINIMAL)
    writer.writerow(["Package", "Class", "Method Name", "Descriptor"])
    for obj in to_store:
        writer.writerow(obj)
