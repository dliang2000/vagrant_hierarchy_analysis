...
case $(id -u) in
    0)
        ...
        apt install -y junit4 maven ant git python3 emacs unzip gradle jq
	apt upgrade -y
  ...
  # ( cd commons-lang3-3.9-src; python3 /vagrant/shared/python_scripts/commons_lang3_3.9_src_processing.py )
    ...
    # ( chmod +x /vagrant/shared/shell_scripts/runjava_joda_time_2.10.5.sh; /vagrant/shared/shell_scripts/runjava_joda_time_2.10.5.sh )
